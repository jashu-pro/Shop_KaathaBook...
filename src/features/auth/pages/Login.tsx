...
import { MobileFastLogin } from '../components/MobileFastLogin';
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          <div style={{
            ...
            fontWeight: '800', fontSize: '1.4rem', marginBottom: '0.65rem',
        ...
        >
          <button
            ...
            style={{
              ...
              borderRadius: '12px',
              border: 'none',
              backgroundColor: authMode === 'mobile' ? 'var(--primary, #3b82f6)' : 'transparent',
              color: authMode === 'mobile' ? '#FFFFFF' : 'var(--text-muted)',
              fontWeight: '700',
              fontSize: '0.825rem',
              cursor: 'pointer',
              transition: 'all 0.2s ease',
              boxShadow: authMode === 'mobile' ? '0 2px 8px rgba(59, 130, 246, 0.3)' : 'none'
            }}
          >
            <Smartphone size={15} />
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '12px',
              border: 'none',
              backgroundColor: authMode === 'email' ? 'var(--primary, #3b82f6)' : 'transparent',
              color: authMode === 'email' ? '#FFFFFF' : 'var(--text-muted)',
              fontWeight: '700',
              fontSize: '0.825rem',
              cursor: 'pointer',
              transition: 'all 0.2s ease',
              boxShadow: authMode === 'email' ? '0 2px 8px rgba(59, 130, 246, 0.3)' : 'none'
            }}
          >
            <Mail size={15} />
        ...
        {/* Content Mode 1: Mobile Fast Login */}
        {authMode === 'mobile' ? (
          <MobileFastLogin onSwitchToEmail={() => setAuthMode('email')} />
        ) : (
          /* Content Mode 2: Email & Password Form */
        ...
        <button
          ...
          style={{ width: '100%', marginBottom: '0.5rem', padding: '0.75rem', gap: '0.65rem', justifyContent: 'center', position: 'relative' }}
        ...
        >
          {isGoogleLoading ? (
            <>
              ...
              <span style={{ color: 'var(--text-muted)' }}>Connecting to Google...</span>
            </>
          ) : (
            <>
